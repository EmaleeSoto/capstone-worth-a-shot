...
import midtownWest from "../images/midtownWest.jpg";
  ...
  return (
    <section className="trending-section">
      ...
      <p className="trending-text">
        "As we near the holidays, we to put together a list of some of the most
        exciting holiday-themed bar pop-ups around New York City. Each year
        various bars and restaurants go all out in holiday spirit with magical
        decorations. Some rooftops become alpine lodges or igloos, However the
        one thing they all have in common are their fun and festive cocktail
        drinks! Whether you're looking to enjoy some holiday cheer, or just want
        to check out a new space, here are all of the holiday pop-up bars that
        should be on your winter list!"
      </p>
      <break></break>
      ...
      <p className="trending-text">
        Take in these beautiful views of the waterfront and the Brooklyn Bridge
        at Watermark's Santa Clause North Pole installation. The experience is
        based off of the new “The Santa Clauses” series on Disney+ and features
        festive IRL areas like Santa's hallway lined with candy cane pillars,
        the Gingerbread House Bar, and Santa's Living Room. When you're done
        with the walkthrough, eat and dine at one of Watermark's heated glass
        houses or snap a photo in front of the giant snow globe!
      ...
      <p className="trending-text">
        ...
        it's pop up winter lounge this year once again. When you're not looking
        at the 25,000 sparkling crystals hanging overhead or trying to capture a
        perfect photo of the Empire State Building, be sure to try out one of
        their Après Ski (boozy pink hot chocolate) or the Pink Campfire S'mores!
      ...
      <p className="trending-text">
        ...
        needed an anti-holiday one, no matter if we've been Naughty or Nice! The
        bar will be decked in over-the-top gaudy Christmas decor and will even
        host events such as seductive burlesque performances!
      ...
      <p className="trending-text">
        ...
        with their staple holiday décor and festive, well-crafted cocktails. The
        pop-up originally began at Mace in 2014, but has since grown globally
        with over 120 locations worldwide, with this year's location being at
        The Cabinet in Alphabet City!
      ...
      <p className="trending-text">
        Experience all the holiday festivities at this “Latin inspired” pop-up!
        Sip on their festive cocktails like A Lump of Coal including blackberry,
        mint, mango butter, black sesame, tequila, lime, egg white, Chilean red
        wine, or the SanTiki Clause with Mezcal, sherry, cinnamon, almond
        orgeat, allspice, and lime all served in holiday-themed glassware.
        <p className="trending-add"> Where: 349 Broome St</p>
      </p>
      <p className="trending-Name">7. Maccabee Bar at Ollie's, West Village</p>
      <h1 className="venue-Header">
        <section className="venue-section">
          <article>
            <img
      ...
      <p className="trending-text">
        A Hannukah-themed pop-up bar is coming to NYC this month, complete with
        decor and festive cocktail drinks! Maccabee Bar (which will be located
        inside Ollie's in the West Village) will be serving unique offerings
        like the Everything Bagel Martini and the Latke Sour.
      ...
      <p className="trending-text">
        Tinsel Town is taking over Pekarna this year, and it's an enchanting and
        immersive Christmas experience. Find Santa, elves, presents, tinsel,
        festive tunes and lots of winter warm drinks. Tickets are required for
        this pop-up.
      ...
      <p className="trending-text">
        ...
        bites and drinks. The over-the-top-decor is picturesque and the staff is
        dressed in ugly sweaters. Plus, the four bars spread across three levels
        makes it seem like you're stepping into a Christmas movie.
      ...
      <p className="trending-text">
        ...
        White Hot Chocolate, Spiked Eggnog, Hot Bourbon Apple Cider, Peppermint
        Nitro Martinis, Gluhwein, Winter Sangria, Hot Toddys, and more. Between
        their heated garden out back and assortment of holiday decor, this is
        the perfect place to hangout, even on the coldest of days.
